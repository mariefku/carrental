...
<div class="panel panel-default">
  ...
  <form class="" action="{{ action('BookingController@confirmItem') }}" method="post">
    ...
    <input type="text" name="id"            value="{{ $databooks-> id }}">
    <input type="text" name="created_at"    value="{{ $databooks-> created_at }}">
    <input type="text" name="updated_at"    value="{{ $databooks-> updated_at }}">
    <input type="text" name="carmodel_id"   value="{{ $databooks-> carmodel_id }}">
    <input type="text" name="plate_number"  value="{{ $databooks-> plate_number }}">
    <input type="text" name="brand"         value="{{ $databooks-> brand }}">
    <input type="text" name="model"         value="{{ $databooks-> model }}">
    <input type="text" name="transmission"  value="{{ $databooks-> transmission }}">
    <input type="text" name="fuel"          value="{{ $databooks-> fuel }}">
    <input type="text" name="car_id"        value="{{ $databooks-> car_id }}">
    <input type="text" name="destination"   value="{{ $databooks-> destination }}">
    <input type="text" name="price"         value="{{ $databooks-> price }}">
    <input type="text" name="year"          value="{{ $databooks-> year }}">
    <input type="text" name="rental_id"     value="{{ $databooks-> rental_id }}">
