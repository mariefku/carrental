    ...
    <input type="hidden" name="img"      value="{{ $databooks-> img }}">
        ...
        <div class="col-sm-6" style="border-left: 1px solid #4caf50">
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              <textarea class="form-control" rows="5" id="alamat" name="alamat" required> {{ old('alamat') }} </textarea>
          ...
          <div class="form-group">
            ...
            <div class="col-sm-12">
              ...
              <input type="text" readonly="" class="form-control" placeholder="cari foto...">
              <input type="file" class="form-control" accept="image/*" id="fotoktp" name="fotoktp" value="{{ old('fotoktp') }}" required>
