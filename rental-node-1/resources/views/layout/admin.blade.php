        ...
        <div class="container-fluid">
          ...
          <div id="navbar" class="navbar-collapse collapse">
            <ul class="nav navbar-nav">
              ...
              <li><a href="{{ action('CarmodelController@listItem') }}">Carmodels</a></li>
              <li><a href="{{ action('BookingController@newItem') }}">Booking List</a></li>
              <li><a href="{{ action('BookingController@allItem') }}">All Booking Data</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div><!--/.container-fluid -->
      </nav>
