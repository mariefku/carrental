      ...
      <div class="panel-body">
          ...
          <div class="col-sm-12">
            ...
            <div class="col-sm-12 text-center bg-danger">
              <strong style="font-size: 24px;font-style: italic;">{{ $items->destination }}</strong>
            </div>
          </div>
          ...
          <div class="col-sm-6" style="padding: 0px 5px;">
            ...
            <div class="col-sm-12 text-center" style="padding: 0px;">
              <input type="hidden"  id="start_date" value="{{ $items->date_rent }}" disabled>
          ...
          <div class="col-sm-6" style="padding: 0px 5px; border-left: 1px solid #f2dede;">
            ...
            <div class="col-sm-12 text-center" style="padding: 0px;">
              <input type="hidden" id="end_date" value="{{ $items->date_return }}" disabled>
          ...
          <div class="col-sm-12">
            ...
            <div class="col-sm-12 text-center bg-danger">
              <strong style="font-size: 24px;font-style: italic;" class="text-danger">Rp {{ $items->price }}</strong>
            </div>
          </div>
      </div>
    </div>
...
<!-- div class="row" style="position: fixed;right: 0;top: 30%;padding-right: 25px;">
    <div class="block">
      <a href="http://localhost/github/rental-central/public/bookings/viewPDF/{{ str_replace("#","",$items->kode_booking) }}" target="_blank">
